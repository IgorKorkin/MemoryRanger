...
enum class HypercallNumber : unsigned __int32 {
  ...
  kMemRangerSetEptNewDriver,  //!< send address of EPT for new driver
...
/*  */
_Use_decl_annotations_ PVOID NTAPI
UtilpGetNTHeaderInfo(PVOID *base_of_image, ULONG &size_of_image);

/*  */
_Use_decl_annotations_ PVOID NTAPI
UtilpGetModuleBasenSize(__in PVOID pc_value, PVOID *base_of_image, ULONG &size_of_image);

/*  */
_Use_decl_annotations_ PVOID NTAPI
UtilpGetAnyModuleHeaderInfo(UNICODE_STRING str, PVOID *base_of_image, ULONG &size_of_image);
